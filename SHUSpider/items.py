...
class NewsItem(scrapy.Item):
    ...
    def get_insert_sql(self):
        insert_sql = """
            insert into tbl_News(md5_id,title, create_date, user_name, url, content, user_id, tag_id)
            VALUES (%s,%s, %s, %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE create_date=VALUES (create_date),user_id=VALUES(user_id),tag_id=VALUES(tag_id)
        """
